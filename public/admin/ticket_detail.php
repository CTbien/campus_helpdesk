        ...
        <div class="row g-4">
            <div class="col-lg-8">
                ...
                <div class="card shadow-sm mt-4">
                    <div class="card-header bg-white py-3">
                        <h5 class="mb-0"><i class="bi bi-clock-history"></i> Historique du ticket</h5>
                    </div>
                    <div class="card-body p-4 bg-light">
                                    ...
                                    <li class="list-group-item bg-transparent px-0 border-bottom border-light">
                                        ...
                                        <p class="mb-1 mt-2">
                                            ...
                                            <?php elseif ($hist['action'] === 'ASSIGNATION'): ?>
                                                <i class="bi bi-person-lines-fill text-info"></i> <strong>Assignation modifiée :</strong> <span class="text-decoration-line-through text-muted"><?= htmlspecialchars($hist['old_value']) ?></span> &rarr; <span class="text-info"><?= $hist['new_value'] ? 'Utilisateur ID #' . htmlspecialchars($hist['new_value']) : 'Non assigné' ?></span>
                                            <?php endif; ?>
                                        </p>
                                    </li>
                                <?php endforeach; ?>
